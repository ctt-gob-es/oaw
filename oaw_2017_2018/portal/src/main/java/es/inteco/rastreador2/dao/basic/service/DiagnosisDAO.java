...
public final class DiagnosisDAO {
	...
	/**
	 * Actualiza la información de histórico del servicio de diagnóstico y
	 * desmarca el registro de resultado guardado
	 *
	 * @param conn
	 *            conexión a la base de datos
	 * @param idBasicService
	 *            el identificador de la solicitud al servicio de diagnósitco
	 * @throws SQLException
	 *             si no se pudo realizar la actualización en la base de datos
	 */
