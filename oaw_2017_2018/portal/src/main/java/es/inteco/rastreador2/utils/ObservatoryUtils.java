...
public final class ObservatoryUtils {
    ...
    public static ActionForward separeSeedToObservatory(HttpServletRequest request, ActionMapping mapping, String id_seed,
                                                        boolean fromAddSeeds, List<SemillaForm> addSeeds, List<SemillaForm> otherSeeds) {
    ...
    //Redirecciona a nuevoObservatorio o añadirSemillas (dependiendo de dónde venga) con los nuevos
    //parámetros de paginación (número de página de listado de semillas, lista de enlaces... )
