    ...
    <div id="main">
        ...
        <div id="container_der">
            ...
            <div id="cajaformularios">
                ...
                <html:form action="/secure/SemillasObservatorio.do" method="post" styleClass="formulario form-horizontal" onsubmit="return validateSemillaObservatorioForm(this)">
                    ...
                    <fieldset>
                        ...
                        <div class="formItem">
                            <label for="inDirectory" class="control-label"><strong class="labelVisu"><acronym title="<bean:message key="campo.obligatorio" />"> * </acronym><bean:message key="editar.semilla.observatorio.in.directory" /></strong></label>
