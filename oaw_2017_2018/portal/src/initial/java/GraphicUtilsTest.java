...
public class GraphicUtilsTest {
    ...
    public void testGraphicsUtils() throws Exception {
        ...
        GraphicsUtils.createPieChart(dataSet, "Distribución del Nivel de Accesibilidad. Segmento I: Principales", sectionLabel, total, "/home/alvaro/na_seg_1.jpg", "", pmgr.getValue(CRAWLER_PROPERTIES, "chart.observatory.graphic.intav.colors"), 565, 464);
    }
    ...
    public void testEvolutionAverageScore() throws Exception {
        ...
        GraphicsUtils.createStandardBarChart(observatoryGraphicsForm, "/home/alvaro/evolution_average_score.jpg", "", messageResources, false);
    }
    ...
    public void testGraphicsGlobalEvolution() throws Exception {
        ...
        final PropertiesManager pmgr = new PropertiesManager();
        GraphicsUtils.createPieChart(dataSet, "", sectionLabel, total, "/home/alvaro/evol_1.jpg", "", pmgr.getValue(CRAWLER_PROPERTIES, "chart.observatory.graphic.intav.colors"), 565, 464);
    }
    ...
    public void testComparacionSegmento() throws Exception {
        ...
        GraphicsUtils.createStackedBarChart(chartForm, noDataMess, "/home/alvaro/adecuacion_seg.jpg");
    }
    ...
    public void testEvaluacionNivelInformeAgregado() throws Exception {
        ...
        GraphicsUtils.createStandardBarChart(chartForm, "/home/alvaro/evolucion_agregado_level_i.jpg", "", messageResources, true);
        ...
        GraphicsUtils.createStandardBarChart(chartForm, "/home/alvaro/evolucion_agregado_level_ii.jpg", "", messageResources, true);
    }
    ...
    public void testEvolucionNivelConformidad() throws Exception {
        ...
        GraphicsUtils.createStackedBarChart(chartForm, noDataMess, "/home/alvaro/evolucion_nivel_conformidad.jpg");
    }
    ...
    public void testEvaluacionPuntuacionMediaAspecto() throws Exception {
        ...
        GraphicsUtils.createStandardBarChart(chartForm, "/home/alvaro/evolucion_puntuacion_media_aspectos.jpg", "", messageResources, true);
    }
    ...
    public void testModalityVerificationSegment() throws Exception {
        ...
        GraphicsUtils.createStackedBarChart(chartForm, "", "/home/alvaro/modality_verification_level_ii_segment_iv.jpg");
    }
