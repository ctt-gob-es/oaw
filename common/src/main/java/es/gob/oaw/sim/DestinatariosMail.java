...
public class DestinatariosMail {
	 ...
	 * not a <CODE>set</CODE> method for the destinatarioMail property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link DestinatarioMail }
	 *
	 * @return the destinatario mail
	 */
