 ...
 *
 */
public class CheckOptgroupTest extends EvaluateCheck {

    private static int OPTGROUP_ID = 407;
    ...
    public void evaluateNoOptgroup() throws Exception {
        checkAccessibility.setContent("<select>" +
                ...
                "</select>");
        Assert.assertEquals(0, getNumProblems(checkAccessibility, OPTGROUP_ID));
    }
    ...
    public void evaluateOptgroupNoLabel() throws Exception {
        checkAccessibility.setContent("<select>" +
                ...
                "<option>Opción 13</option>" +
                "</select>");
        Assert.assertEquals(1, getNumProblems(checkAccessibility, OPTGROUP_ID));
    }
