...
public final class Check_1_2_1_OtherLanguagesTest {
	...
	public void setUp() throws Exception {
		checkAccessibility = TestUtils.getCheckAccessibility("observatorio-une-201-b");
	}
	...
	/*
	 * MET 4.8.1 - Se verifica que todos los idiomas especificados por los
	 * elementos sean válidos (ID 161) MET 4.8.2 - Se verifica que los cambios
	 * de idioma más habituales encontrados en un documento se marquen
	 * adecuadamente (ID 93) MET 4.8.3 - Se verifica que los textos en inglés
	 * encontrados en un documento se marquen adecuadamente (NUEVA)
	 * 
	 * VALID_LANGUAGE_ELEMENT = 161; LANGUAGE_CHANGE_LINKS = 93; OTHER_LANGUAGES
	 * = 460;
	 * 
	 */
	@Test
	public void MET_4_8_3_evaluateLanguageChanges() throws Exception {
		...
		/*
		 * MET 4.8.3 Title: Se verifica que los textos en inglés (que contienen
		 * alguna de las 100 palabras más habituales) están correctamente
		 * identificados. Se busca en textos, alternativas textuales y títulos.
		 * Subject: * Check: Si el texto está en inglés debe estar identificado
		 * con lang="en" (u otras variedades de inglés).
		 * 
		 */
	...
	public void evaluateLanguageLinks() throws Exception {
		checkAccessibility.setContent("<html lang=\"es\"><body><p>Lorem</p>" + "<div class=\"menuRecurrente\">\n" + "    <ul>\n" + "      <li>\n" + "        <span lang=\"es\">\n"
	...
	/**
	 * Prueba de detección de siglas como palabras en otro idioma dentro de
	 * etiquetas abbr o acronym
	 * 
	 * @throws Exception
	 */
	@Test
