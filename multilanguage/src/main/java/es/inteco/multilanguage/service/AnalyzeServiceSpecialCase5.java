...
public class AnalyzeServiceSpecialCase5 {
    ...
    public List<Analysis> analyze(List<Analysis> analysisList, AnalysisConfiguration analysisConfiguration) throws Exception {
        ...
        MultilanguageUtils.getUrlsFromXml(analysisList, analysisConfiguration);
        MultilanguageUtils.getLanguagesFromHome(analysisList);
        return analysisList;
    }
}
