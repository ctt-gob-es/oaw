...
public class TestSIM {
    ...
    public void testExportEvolutionPdf() {
        ...
        try {
            ...
            PrimaryExportPdfUtils.exportToPdf(new AnonymousResultExportPdfUNE2012(), idRastreoRealizado, evaluationIds, previousEvaluationIds, MessageResources.getMessageResources("ApplicationResources"), "/home/alvaro/Desktop/test_evolution_results.pdf", "Seed", "", idObservatoryExecution, 0);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void testExportPreviousPdf() {
        ...
        try {
            ...
            Assert.assertTrue("No hay evaluaciones", !evaluationIds.isEmpty());
            PrimaryExportPdfUtils.exportToPdf(new AnonymousResultExportPdfUNE2012(), idRastreoRealizado, evaluationIds, previousEvaluationIds, MessageResources.getMessageResources("ApplicationResources"), "/home/alvaro/Desktop/test_initial_results.pdf", "Seed", "", idObservatoryExecution, 0);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
