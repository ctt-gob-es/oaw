...
public class FreeSpaceServlet extends GenericServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		try {
			...
			CronTrigger cronTrigger = new CronTriggerImpl("FreeSpaceJob", "FreeSpaceJobGroup", getInitParameter("cronExpression"));
			JobDetail jobDetail = new JobDetailImpl("FreeSpaceJob", "FreeSpaceJobGroup", FreeSpaceJob.class);
