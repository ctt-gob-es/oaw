...
public class BasePagingDtoImpl extends BaseDto implements BasePagingDto {
     ...
     */
    private static final int DEFAULT_PAGE_SIZE = Integer.parseInt(ConfigUtil.getConfiguracion().getProperty("maxRows"));
    ...
    public void appendOrderToQuery(StringBuffer hql) {
        if ((PROPERTY_ORDER_ASC.equals(order) || PROPERTY_ORDER_DESC.equals(order)) && (propertyOrder != null) && (propertyOrder.length() > 0)) {
