        ...
        try (Connection c = DataBaseManager.getConnection()) {
            ...
            if (CrawlerUtils.hasAccess(request, "google.results.seed")) {
                ...
                if (errors == null || errors.isEmpty()) {
                    ...
                    SemillaDAO.insertList(c, Constants.ID_LISTA_SEMILLA, nuevaSemillaGoogleForm.getNombreSemilla(), listaUrls, nuevaSemillaGoogleForm.getCategoria().getId(),  null, null, null);
