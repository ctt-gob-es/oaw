            ...
            try (Connection c = DataBaseManager.getConnection()) {
                if (CrawlerUtils.hasAccess(request, "web.list.seed")) {
                    ...
                    if (errors.isEmpty()) {
                        ...
                        SemillaDAO.insertList(c, Constants.ID_LISTA_SEMILLA, nuevaSemillaWebsForm.getNombreSemilla(), SeedUtils.getSeedUrlsForDatabase(validUrls), nuevaSemillaWebsForm.getCategoria().getId(), null, null, null);
