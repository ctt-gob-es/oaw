...
public final class AnnexUtils {
	...
	private static void InsertAgregatePieChar(XSSFSheet currentSheet3, int rowIndex, List<String> columnNames, CellStyle headerStyle, CellStyle shadowStyle) {
		...
		XDDFDataSource<String> labels = XDDFDataSourcesFactory.fromStringCellRange(currentSheet3,
				new CellRangeAddress(1, 3, 0, 0));

		XDDFNumericalDataSource<Double> values = XDDFDataSourcesFactory.fromNumericCellRange(currentSheet3,
