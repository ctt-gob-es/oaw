...
public final class ResultadosAnonimosObservatorioUNE2012Utils {
    ...
    public static List<GraphicData> infoGlobalAccessibilityLevel(HttpServletRequest request,
        ...
        labelValue = new GraphicData();
        labelValue.setAdecuationLevel(CrawlerUtils.getResources(request).getMessage("resultados.anonimos.porc.portales.parcial"));
        if (totalPort > 0) {
    ...
    public static List<LabelValueBean> infoComparisonBySegment(HttpServletRequest request,
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("resultados.anonimos.punt.portales.parcial"));
    ...
    public static List<LabelValueBean> infoLevelIVerificationMidsComparison(HttpServletRequest request,
        ...
        LabelValueBean labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.1.1.1"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.1.1.2"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.1.1.3"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.1.1.4"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.1.1.5"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.1.1.6"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.1.1.7"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.1.2.1"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.1.2.2"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.1.2.3"));
    ...
    public static List<LabelValueBean> infoLevelIIVerificationMidsComparison(HttpServletRequest request,
        ...
        LabelValueBean labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.2.1.1"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.2.1.2"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.2.1.3"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.2.1.4"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.2.1.5"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.2.1.6"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.2.1.7"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.2.2.1"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.2.2.2"));
        ...
        labelValue = new LabelValueBean();
        labelValue.setLabel(CrawlerUtils.getResources(request).getMessage("minhap.observatory.2_0.subgroup.2.2.3"));
    ...
    public static void getMidMarkVerificationEvolutionGraphic(HttpServletRequest request, String verification, String noDataMess,
        ...
        if (verification.equals(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_111_VERIFICATION)) {
            ...
            request.setAttribute(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_DATA_LIST_V115, infoMidMarkVerificationEvolutionGraphic(request, resultData));
        } else if (verification.equals(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_116_VERIFICATION)) {
            request.setAttribute(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_DATA_LIST_V116, infoMidMarkVerificationEvolutionGraphic(request, resultData));
        } else if (verification.equals(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_117_VERIFICATION)) {
            request.setAttribute(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_DATA_LIST_V117, infoMidMarkVerificationEvolutionGraphic(request, resultData));
            ...
            request.setAttribute(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_DATA_LIST_V215, infoMidMarkVerificationEvolutionGraphic(request, resultData));
        } else if (verification.equals(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_216_VERIFICATION)) {
            request.setAttribute(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_DATA_LIST_V216, infoMidMarkVerificationEvolutionGraphic(request, resultData));
        } else if (verification.equals(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_217_VERIFICATION)) {
            request.setAttribute(Constants.OBSERVATORY_GRAPHIC_EVOLUTION_DATA_LIST_V217, infoMidMarkVerificationEvolutionGraphic(request, resultData));
    ...
    public static Map<Date, Map<Long, Map<String, Integer>>> getEvolutionObservatoriesSitesByType(final HttpServletRequest request, final Map<Date, List<ObservatoryEvaluationForm>> result) {
        ...
        try {
            ...
            Map<Long, Date> executedObservatoryIdMap = ObservatorioDAO.getObservatoryExecutionIds(c, Long.parseLong(observatoryId), Long.parseLong(executionId), observatoryForm.getCartucho().getId());
    ...
    public static void getGlobalAccessibilityLevelAllocationSegmentGraphic(HttpServletRequest request,
        ...
        if (!file.exists() || regenerate) {
            ...
            dataSet.setValue(GraphicsUtils.parseLevelLabel(Constants.OBS_PARCIAL, request), result.get(Constants.OBS_NV));
    ...
    public static void debugChecks(HttpServletRequest request, List<ObservatoryEvaluationForm> pageExecutionList) {
        ...
        try {
            ...
            Logger.putLog("Error al depurar los checks que más fallan en el Observatorio", ResultadosAnonimosObservatorioUNE2012Utils.class, Logger.LOG_LEVEL_WARNING);
        } finally {
            try {
                if (writer != null) {
                    writer.close();
                ...
                Logger.putLog("Excepción", ResultadosAnonimosObservatorioUNE2012Utils.class, Logger.LOG_LEVEL_WARNING);
            }
        }
    }
