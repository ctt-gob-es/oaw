...
public final class AnonymousResultExportPdfSections {
    ...
    protected static int createEvolutionResultsChapter(HttpServletRequest request, IndexEvents index, Document document,
        ...
        Section section1L1 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv1.level1.title"), index, ConstantsFont.chapterTitleMPFont2L, chapter, countSections, 1);
        PDFUtils.addParagraph(messageResources.getMessage("ob.resAnon.intav.report.Ev1.p1"), ConstantsFont.paragraphFont, section1L1);
        PDFUtils.addParagraph(messageResources.getMessage("ob.resAnon.intav.report.Ev1.p2"), ConstantsFont.paragraphFont, section1L1, Paragraph.ALIGN_JUSTIFIED, true, true);
        section1L1.newPage();
        Section section1 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv1.title"), index, ConstantsFont.chapterTitleMPFont3L, section1L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv1(request, section1, graphicPath, resultDataA);
        section1L1.newPage();
        Section section2 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv2.title"), index, ConstantsFont.chapterTitleMPFont3L, section1L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv2(request, section2, graphicPath, resultDataAA);
        section1L1.newPage();
        Section section3 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv3.title"), index, ConstantsFont.chapterTitleMPFont3L, section1L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv3(request, section3, graphicPath, resultDataNV);
        section1L1.newPage();

        Section section4 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv4.title"), index, ConstantsFont.chapterTitleMPFont3L, chapter, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv4(request, section4, graphicPath, pageObservatoryMap);
        section4.newPage();

        Section section3L1 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.verification.level1.title"), index, ConstantsFont.chapterTitleMPFont2L, chapter, countSections, 1);
        PDFUtils.addParagraph(messageResources.getMessage("ob.resAnon.intav.report.Ev5.p1"), ConstantsFont.paragraphFont, section3L1, Paragraph.ALIGN_JUSTIFIED, true, true);
        section3L1.newPage();
        Section section5 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv5.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv5(request, section5, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section6 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv6.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv6(request, section6, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section7 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv7.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv7(request, section7, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section8 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv8.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv8(request, section8, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section9 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv9.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv9(request, section9, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section10 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv10.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv10(request, section10, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section11 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv11.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv11(request, section11, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section12 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv12.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv12(request, section12, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section13 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv13.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv13(request, section13, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section14 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv14.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv14(request, section14, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section15 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv15.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv15(request, section15, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section16 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv16.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv16(request, section16, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section17 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv17.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv17(request, section17, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section18 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv18.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv18(request, section18, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section19 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv19.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv19(request, section19, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section20 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv20.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv20(request, section20, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section21 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv21.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv21(request, section21, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section22 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv22.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv22(request, section22, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section23 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv23.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv23(request, section23, graphicPath, pageObservatoryMap);
        section3L1.newPage();
        Section section24 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv24.title"), index, ConstantsFont.chapterTitleMPFont3L, section3L1, countSections++, 2);
        ...
        Section section4L1 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.aspect.level1.title"), index, ConstantsFont.chapterTitleMPFont2L, chapter, countSections, 1);
        PDFUtils.addParagraph(messageResources.getMessage("ob.resAnon.intav.report.Ev25.p1"), ConstantsFont.paragraphFont, section4L1, Paragraph.ALIGN_JUSTIFIED, true, true);
        section4L1.newPage();
        Section section25 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv25.title"), index, ConstantsFont.chapterTitleMPFont3L, section4L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv25(request, section25, graphicPath, resultsByAspect);
        section4L1.newPage();
        Section section26 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv26.title"), index, ConstantsFont.chapterTitleMPFont3L, section4L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv26(request, section26, graphicPath, resultsByAspect);
        section4L1.newPage();
        Section section27 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv27.title"), index, ConstantsFont.chapterTitleMPFont3L, section4L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv27(request, section27, graphicPath, resultsByAspect);
        section4L1.newPage();
        Section section28 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv28.title"), index, ConstantsFont.chapterTitleMPFont3L, section4L1, countSections++, 2);
        AnonymousResultExportPdfSectionEv.createSectionEv28(request, section28, graphicPath, resultsByAspect);
        section4L1.newPage();
        Section section29 = PDFUtils.addSection(messageResources.getMessage("ob.resAnon.intav.report.chapterEv29.title"), index, ConstantsFont.chapterTitleMPFont3L, section4L1, countSections++, 2);
