...
public class AnonymousResultPdfUNE2004Builder extends AnonymousResultPdfBuilder {
    ...
    private void createChapter1(final MessageResources resources, final Chapter chapter) {
        chapter.add(PDFUtils.createParagraphWithDiferentFormatWord(resources.getMessage("ob.resAnon.intav.report.1.p1"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.1.p1.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true));
        Paragraph p = PDFUtils.createParagraphWithDiferentFormatWord(resources.getMessage("ob.resAnon.intav.report.1.p2"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.1.p2.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        p.add(new Phrase(resources.getMessage("ob.resAnon.intav.report.1.p2.m1"), ConstantsFont.paragraphUnderlinedFont));
        chapter.add(p);
        chapter.add(PDFUtils.createParagraphWithDiferentFormatWord(resources.getMessage("ob.resAnon.intav.report.1.p3"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.1.p3.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true));
    ...
    private void createSection11(final MessageResources resources, final Section section) {
        section.add(PDFUtils.createParagraphWithDiferentFormatWord(resources.getMessage("ob.resAnon.intav.report.11.p4"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.11.p4.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true));
        PDFUtils.addParagraph(resources.getMessage("ob.resAnon.intav.report.11.p5"), ConstantsFont.PARAGRAPH, section);
        section.add(PDFUtils.createParagraphWithDiferentFormatWord(resources.getMessage("ob.resAnon.intav.report.11.p1"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.11.p1.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true));
    }
    ...
    protected void createMethodologyChapter(final MessageResources resources, final Font titleFont, final java.util.List<ObservatoryEvaluationForm> primaryReportPageList, final boolean isBasicService) throws Exception {
        ...
        Section section3 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapter33.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_2_L, chapter, countSections++, 1, resources.getMessage("anchor.met.table"));
    ...
    private void createSection32(final MessageResources resources, final Section section, final java.util.List<ObservatoryEvaluationForm> primaryReportPageList, final long observatoryType, final boolean isBasicService) {
        if (!isBasicService) {
            section.add(PDFUtils.createParagraphWithDiferentFormatWord(resources.getMessage("ob.resAnon.intav.report.32.p1"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.32.p1.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true));
        ...
        final List list = new List();
        list.add(PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.32.p5"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.32.p5.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true));
        list.add(PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.32.p6"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.32.p6.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true));
        list.setIndentationLeft(ConstantsFont.IDENTATION_LEFT_SPACE);
        section.add(list);
    ...
    private Section createSection33(MessageResources resources, Section section) throws BadElementException, IOException {
        ...
        List list = new List();
        ListItem item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p3"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p2")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);

        List list2 = new List();
        ListItem itemL2 = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p5"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p4")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list2.add(itemL2);
        itemL2 = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p7"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p6")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list2.add(itemL2);
        ...
        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p9"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p8")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);

        list2 = new List();
        itemL2 = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p11"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p10")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list2.add(itemL2);
        itemL2 = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p13"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p12")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list2.add(itemL2);
        list2.setIndentationLeft(ConstantsFont.IDENTATION_LEFT_SPACE);
        item.add(list2);
        ...
        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p16"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p15")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        list.add(item);
        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p18"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p17")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        list.add(item);
        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p20"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p19")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        list.add(item);
        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p22"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p21")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        list.add(item);
        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p24"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p23")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        list.add(item);
        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.33.p26"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p25")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        list.add(item);
        ...
        section.add(PDFUtils.createParagraphWithDiferentFormatWord(resources.getMessage("ob.resAnon.intav.report.33.p30"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.33.p30.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true));
    ...
    private void createSection34(final MessageResources resources, Section section) {
        section.add(PDFUtils.createParagraphWithDiferentFormatWord(resources.getMessage("ob.resAnon.intav.report.34.p1"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.34.p1.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true));
    ...
    private void createSection341(final MessageResources resources, Section section) {
        ...
        ListItem item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p3"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p2")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        list.add(item);

        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p5"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p4")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list.add(item);

        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p7"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p6")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list.add(item);
        ...
        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p10"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p9")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        list.add(item);

        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p12"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p11")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list.add(item);

        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p14"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p13")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list.add(item);
        ...
        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p17"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p16")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        list.add(item);

        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p19"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p18")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list.add(item);

        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p21"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p20")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list.add(item);
        ...
        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p24"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p23")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true);
        list.add(item);

        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p26"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p25")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list.add(item);

        item = PDFUtils.addMixFormatListItem(resources.getMessage("ob.resAnon.intav.report.341.p28"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p27")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, false);
        list.add(item);

        list.setIndentationLeft(5 * ConstantsFont.IDENTATION_LEFT_SPACE);
        section.add(list);

        section.add(PDFUtils.createParagraphWithDiferentFormatWord(resources.getMessage("ob.resAnon.intav.report.341.p29"), Collections.singletonList(resources.getMessage("ob.resAnon.intav.report.341.p29.bold")), ConstantsFont.paragraphBoldFont, ConstantsFont.PARAGRAPH, true));
    }
    ...
    protected void createGlobalResultsChapter(final MessageResources resources, Font titleFont, String graphicPath, String execution_id, java.util.List<CategoriaForm> categories) throws Exception {
        ...
        Section section1 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapter41.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_2_L, chapter, countSections++, 1, resources.getMessage("anchor.4.1"));
        ...
        Section section3 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapter43.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_2_L, chapter, countSections++, 1, resources.getMessage("anchor.4.3"));
        createSection43(resources, section3, graphicPath, execution_id, pageExecutionList, categories);
        if (categories.size() != 5) {
            chapter.newPage();
        }

        Section section4 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapter44.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_2_L, chapter, countSections++, 1, resources.getMessage("anchor.PuMe"));
        createSection44(resources, section4, graphicPath, pageExecutionList);
        chapter.newPage();

        Section section5 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapter45.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_2_L, chapter, countSections++, 1, resources.getMessage("anchor.PoMo"));
    ...
    protected void createCategoryResultsChapter(final MessageResources resources, Font titleFont, String graphicPath, String execution_id, CategoriaForm category) throws Exception {
        ...
        Chapter chapter = PDFUtils.createChapterWithTitle(resources.getMessage("ob.resAnon.intav.report.chapterCat.title") + " " + category.getName().toUpperCase(), index, countSections++, numChapter, titleFont);
    ...
    protected void createEvolutionResultsChapter(final MessageResources resources, Font titleFont, String graphicPath, String idExecution, String idObservatory) throws Exception {
        ...
        final Section section1L1 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv1.level1.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_2_L, chapter, countSections, 1);
        ...
        final Section section1 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv1.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section1L1, countSections++, 2);
        ...
        final Section section2 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv2.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section1L1, countSections++, 2);
        ...
        final Section section3 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv3.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section1L1, countSections++, 2);
        ...
        final Section section3L1 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.verification.level1.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_2_L, chapter, countSections, 1);
        ...
        final Section section5 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv5.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section6 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv6.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section7 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv7.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section8 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv8.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section9 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv9.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section10 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv10.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section11 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv11.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section12 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv12.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section13 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv13.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section14 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv14.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section15 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv15.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section16 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv16.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section17 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv17.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section18 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv18.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section19 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv19.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section20 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv20.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section21 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv21.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section22 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv22.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section23 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv23.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        section3L1.newPage();
        final Section section24 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv24.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section3L1, countSections++, 2);
        ...
        final Section section4L1 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.aspect.level1.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_2_L, chapter, countSections, 1);
        ...
        section4L1.newPage();
        final Section section25 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv25.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section4L1, countSections++, 2);
        ...
        section4L1.newPage();
        final Section section26 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv26.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section4L1, countSections++, 2);
        ...
        section4L1.newPage();
        final Section section27 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv27.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section4L1, countSections++, 2);
        ...
        section4L1.newPage();
        final Section section28 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv28.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section4L1, countSections++, 2);
        ...
        section4L1.newPage();
        final Section section29 = PDFUtils.createSection(resources.getMessage("ob.resAnon.intav.report.chapterEv29.title"), index, ConstantsFont.CHAPTER_TITLE_MP_FONT_3_L, section4L1, countSections++, 2);
