 ...
 */
public class AnonymousResultPdfUNEEN2019Builder extends AnonymousResultPdfBuilder {
	/**
	 ...
	 */
	public AnonymousResultPdfUNEEN2019Builder(File fileOut, long observatoryType) throws Exception {
