 ...
 * @version 1.0
 */
public class ExportPageEventsObservatoryBS extends PdfPageEventHelper {
    ...
    public ExportPageEventsObservatoryBS(String footText, String date) {
    ...
    public final void onEndPage(final PdfWriter w, final Document d) {
        try {
            ...
            Logger.putLog("Exception", ExportPageEventsObservatoryBS.class, es.inteco.common.logging.Logger.LOG_LEVEL_ERROR, e);
        }
    }
