...
public final class MultilanguageAnonymousResultExportPdfSection3 {
    ...
    protected static void createSection33(HttpServletRequest request, Section section) {
        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.33.p1"), ConstantsFont.paragraphFont, section);

        List list = new List();
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.33.p2"), list, ConstantsFont.paragraphFont);
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.33.p3"), list, ConstantsFont.paragraphFont);
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.33.p4"), list, ConstantsFont.paragraphFont);
        list.setIndentationLeft(ConstantsFont.IDENTATION_LEFT_SPACE);
        section.add(list);

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.33.p5"), ConstantsFont.paragraphFont, section);
        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.33.p6"), ConstantsFont.paragraphFont, section);
    }
    ...
    protected static void createSection331(HttpServletRequest request, Section section) {
        ...
        section.add(PDFUtils.createParagraphWithDiferentFormatWord(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p1"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true));

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p2"), ConstantsFont.paragraphFont, section);

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p3"), ConstantsFont.paragraphFont, section);

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p4"), ConstantsFont.paragraphFont, section);

        List list = new List();

        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p5.bold"));
        ListItem item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p5"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p6.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p6"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p7.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p7"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p8.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p8"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p9.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p9"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p10.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p10"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p11.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p11"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);

        list.setIndentationLeft(ConstantsFont.IDENTATION_LEFT_SPACE);
        section.add(list);

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p12"), ConstantsFont.paragraphFont, section);

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.331.p13"), ConstantsFont.paragraphFont, section);
    }
    ...
    protected static void createSection332(HttpServletRequest request, Section section) {
        ...
        section.add(PDFUtils.createParagraphWithDiferentFormatWord(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p1"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true));

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p2"), ConstantsFont.paragraphFont, section);

        List list = new List();

        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p3.bold"));
        ListItem item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p3"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p4.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p4"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p5.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p5"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p6.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p6"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p7.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p7"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p8.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p8"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);
        boldWords = new ArrayList<String>();
        boldWords.add(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p9.bold"));
        item = PDFUtils.addMixFormatListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p9"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true);
        list.add(item);

        list.setIndentationLeft(ConstantsFont.IDENTATION_LEFT_SPACE);
        section.add(list);

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p10"), ConstantsFont.paragraphFont, section);

        list = new List();
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p11"), list, ConstantsFont.paragraphFont);
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p12"), list, ConstantsFont.paragraphFont);
        list.setIndentationLeft(ConstantsFont.IDENTATION_LEFT_SPACE);
        section.add(list);
        ...
        section.add(PDFUtils.createParagraphAnchor(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p13"), anchorMap, ConstantsFont.paragraphFont));

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.332.p14"), ConstantsFont.paragraphFont, section);
    ...
    protected static void createSection333(HttpServletRequest request, Section section) {
        ...
        section.add(PDFUtils.createParagraphWithDiferentFormatWord(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p1"), boldWords, ConstantsFont.paragraphBoldFont, ConstantsFont.paragraphFont, true));

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p2"), ConstantsFont.paragraphFont, section);

        Paragraph p = new Paragraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p3.1"), ConstantsFont.paragraphFont);
        ...
        p.add(ph);
        ph = new Phrase(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p3.3"), ConstantsFont.paragraphFont);
        p.add(ph);
        section.add(p);

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p4"), ConstantsFont.paragraphFont, section);

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p5"), ConstantsFont.paragraphFont, section);

        List list = new List();
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p6"), list, ConstantsFont.paragraphFont);
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p7"), list, ConstantsFont.paragraphFont);
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p8"), list, ConstantsFont.paragraphFont);
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p9"), list, ConstantsFont.paragraphFont);
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p10"), list, ConstantsFont.paragraphFont);
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p11"), list, ConstantsFont.paragraphFont);
        PDFUtils.addListItem(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p12"), list, ConstantsFont.paragraphFont);
        list.setIndentationLeft(ConstantsFont.IDENTATION_LEFT_SPACE);
        section.add(list);

        PDFUtils.addParagraph(CrawlerUtils.getResources(request).getMessage("ob.resAnon.multilanguage.report.333.p13"), ConstantsFont.paragraphFont, section);
    }
    ...
    private static PdfPTable addURLTable(HttpServletRequest request, java.util.List<AnalysisForm> analysisList) {
        ...
        for (AnalysisForm analysisForm : analysisList) {
            ...
            PdfPCell url = new PdfPCell(PDFUtils.addLinkParagraph(analysisForm.getUrl(), analysisForm.getUrl(), ConstantsFont.noteCellFont));
            table.addCell(url);
        }
