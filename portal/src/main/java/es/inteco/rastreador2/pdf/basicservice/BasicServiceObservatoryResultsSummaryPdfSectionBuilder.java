...
public class BasicServiceObservatoryResultsSummaryPdfSectionBuilder {
    ...
    private void createTablaResumenResultadosPorNivel(final MessageResources messageResources, final Chapter chapter, final List<ObservatoryEvaluationForm> evaList, final int groupIndex, final PdfTocManager pdfTocManager) {
