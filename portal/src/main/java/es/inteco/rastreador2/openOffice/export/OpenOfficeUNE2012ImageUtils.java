...
public final class OpenOfficeUNE2012ImageUtils {
	...
	private static final Map<String, String> AGE_IMAGES = Collections.unmodifiableMap(new HashMap<String, String>() {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 8410235097710873718L;
		{
			...
			put("EvolucionPuntuacionMediaVerificacionNAICombinada.jpg", "10000000000005B90000028E7845A92B04452C51.jpg");
			put("EvolucionPuntuacionMediaVerificacionNAIICombinada.jpg", "10000000000005B90000028EEFD7DC73058134FF.jpg");
	...
	private static final Map<String, String> CCAA_IMAGES = Collections.unmodifiableMap(new HashMap<String, String>() {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -3156472286310200116L;
		{
	...
	private static final Map<String, String> EELL_IMAGES = Collections.unmodifiableMap(new HashMap<String, String>() {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 4974787307331622164L;
		{
	...
	/**
	 * Instantiates a new open office UNE 2012 image utils.
	 */
