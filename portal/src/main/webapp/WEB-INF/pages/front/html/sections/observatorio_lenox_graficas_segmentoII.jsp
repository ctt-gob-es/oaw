...
<inteco:sesion action="ifConfigAdmin">
	...
	<bean:define id="grRegenerate" ><%= Constants.OBSERVATORY_GRAPHIC_SEGMENT_II %></bean:define>
	...
	<div id="migas">
		...
		<bean:message key="migas.indice.observatorios.menu.graficas.segmento2"/>
		</p>
	</div>
				...
				<div id="cuerpoprincipal">
					...
					<div id="container_der">
						...
						<div id="cajaformularios">
							<h2 class="config"><bean:message key="indice.observatorios.menu.graficas.segmento2" /></h2>
							...
							<logic:equal name="<%= Constants.OBSERVATORY_RESULTS %>" value="<%= Constants.SI %>">
								<logic:notEmpty name="<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_PERCENTAGE_TERMS %>">
									<h3><bean:message key="resultados.anonimos.lenox.porcentaje.prioridad.terminos.s2.title" /></h3>
									...
									<div class="divCenter"><img src="<%=request.getContextPath()%>/secure/GraficasObservatorio.do?<%= Constants.TYPE_OBSERVATORY %>=<%= observatoryType %>&amp;<%= Constants.ID %>=<%= id %>&amp;<%= Constants.ID_OBSERVATORIO %>=<%= id_observatorio %>&amp;<%= Constants.GRAPHIC %>=<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_PERCENTAGE_SEG2 %>"></img></div>
								</logic:notEmpty>
