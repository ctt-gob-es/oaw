...
<ul role="presentation" class="nav nav-pills nav-stacked">
	<inteco:menu roles="<%=rolAdmin + \";\" + rolConfig + \";\" + rolObservatory%>">
		...
		<logic:notEqual name="<%=Constants.MENU%>" value="<%=Constants.MENU_INTECO_OBS%>">
			<li><html:link forward="observatoryMenu" titleKey="menuadmin.observatorio.title">
			...
			<ul role="presentation" class="nav nav-pills nav-stacked">
				<inteco:menu roles="<%=rolAdmin + \";\" + rolConfig%>">
					...
					<logic:equal name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_CATEGORIES%>">
						<li class="active"><html:link forward="getSeedCategories" styleId="subselected"
					...
					<logic:notEqual name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_CATEGORIES%>">
						<li><html:link forward="getSeedCategories" titleKey="menuconfig.semillas.listado.categorias.title">
								<bean:message key="menuconfig.semillas.listado.categorias" />
							</html:link>
					</logic:notEqual>
		</li>
		...
		<logic:equal name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_OBS_SEMILLA%>">
			<li class="active"><html:link styleId="subselected" forward="observatorySeed"
					titleKey="menu.config.observatory.seed.title">
					<bean:message key="menu.config.observatory.seed" />
				</html:link>
		</logic:equal>
		<logic:notEqual name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_OBS_SEMILLA%>">
			<li><html:link forward="observatorySeed" titleKey="menu.config.observatory.seed.title">
					<bean:message key="menu.config.observatory.seed" />
				</html:link>
		</logic:notEqual>
		</li>
		...
		<logic:equal name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_OBS_DEPENDENCIAS%>">
			<li class="active"><html:link styleId="subselected" forward="observatoryDependencias"
					titleKey="menu.config.dependencias.title">
					<bean:message key="menu.config.dependencias" />
				</html:link>
		</logic:equal>
		<logic:notEqual name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_OBS_DEPENDENCIAS%>">
			<li><html:link forward="observatoryDependencias" titleKey="menu.config.dependencias.title">
					<bean:message key="menu.config.dependencias" />
				</html:link>
		</logic:notEqual>
		</li>
		...
		<logic:equal name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_OBS_COMPLEJIDADES%>">
			<li class="active"><html:link styleId="subselected" forward="observatoryComplejidades"
					titleKey="menu.config.complejidades.title">
		...
		<logic:notEqual name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_OBS_COMPLEJIDADES%>">
			<li><html:link forward="observatoryComplejidades" titleKey="menu.config.complejidades.title">
					<bean:message key="menu.config.complejidades" />
				</html:link>
		</logic:notEqual>
		</li>
		...
		<logic:equal name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_OBS_ETIQUETAS%>">
			<li class="active"><html:link styleId="subselected" forward="observatoryEtiquetas"
		...
		<logic:notEqual name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_OBS_ETIQUETAS%>">
			<li><html:link forward="observatoryEtiquetas" titleKey="menu.config.etiquetas.title">
					<bean:message key="menu.config.etiquetas" />
				</html:link>
		</logic:notEqual>
		</li>
		...
		<logic:notEqual name="<%=Constants.SUBMENU%>" value="<%=Constants.SUBMENU_OBS_PLANTILLAS%>">
			<li><html:link forward="observatoryPlantillas" titleKey="menu.config.etiquetas.title">
					<bean:message key="menu.config.plantillas" />
				</html:link>
		</logic:notEqual>
		</li>
...
<inteco:menu roles="<%=rolAdmin%>">
	...
	<li>
		<ul role="presentation" class="nav nav-pills nav-stacked">
			...
			<logic:notEqual name="<%=Constants.MENU%>" value="<%=Constants.MENU_SERVICIO_DIAGNOSTICO%>">
				<li><html:link forward="servicioDiagnostico" titleKey="menuadmin.exportar_servicio_diagnostico.title">
						<bean:message key="menuadmin.exportar_servicio_diagnostico" />
					</html:link>
			</logic:notEqual>
		</ul>
...
<ul class="dropdown-menu nav nav-stacked nav-pills">
	<li><logic:equal name="<%=Constants.MENU%>" value="<%=Constants.MENU_PASSWORD%>">
		...
		</logic:equal> <logic:notEqual name="<%=Constants.MENU%>" value="<%=Constants.MENU_PASSWORD%>">
			<html:link forward="changePassMenu" titleKey="menuvisor.cambiar.pass.title">
				<bean:message key="menuvisor.cambiar.pass" />
			</html:link>
		</logic:notEqual></li>
	<inteco:menu roles="<%=rolAdmin%>">
		<li><logic:equal name="<%=Constants.MENU%>" value="<%=Constants.MENU_USERS%>">
				<html:link forward="usersMenu" styleId="selected" titleKey="menuadmin.usuarios.title">
					<bean:message key="menuadmin.usuarios" />
				</html:link>
			</logic:equal> <logic:notEqual name="<%=Constants.MENU%>" value="<%=Constants.MENU_USERS%>">
	...
	<inteco:menu roles="<%=rolAdmin + \";\" + rolConfig%>">
		<li><html:link forward="clientAccountsMenu" styleId="selected" titleKey="menuadmin.cuenta.usuarios.title">
				<bean:message key="menuadmin.cuenta.usuarios" />
			</html:link></li>
	</inteco:menu>
	<inteco:menu roles="<%=rolAdmin + \";\" + rolConfig + \";\" + rolVisor%>">
		<li><html:link styleId="selected" forward="crawlingsMenu" titleKey="menuadmin.rastreos.title">
				<bean:message key="menuadmin.rastreos" />
			</html:link></li>
	</inteco:menu>
	<inteco:menu roles="<%=rolAdmin + \";\" + rolConfig%>">
		<li><html:link forward="listSeedsMenu" styleId="subselected" titleKey="menuadmin.semillas.listado.semillas.title">Semillas</html:link>
			<ul class="nav nav-stacked nav-pills">
				<li><html:link forward="listSeedsMenu" styleId="subselected"
						titleKey="menuadmin.semillas.listado.semillas.title">
						<bean:message key="menuadmin.semillas.listado.semillas" />
					</html:link></li>
				<li><html:link forward="ipSeedsMenu" styleId="subselected" titleKey="menuadmin.semillas.rangoIP.title">
						<bean:message key="menuadmin.semillas.rangoIP" />
					</html:link></li>
				<li><html:link forward="googleSeedsMenu" styleId="subselected"
						titleKey="menuadmin.semillas.resultados.google.title">
						<bean:message key="menuadmin.semillas.resultados.google" />
					</html:link></li>
				<li><html:link forward="conectividadMenu" styleId="subselected" titleKey="menuadmin.conectividad.title">
