				...
				<div id="cuerpoprincipal">
					...
					<div id="container_der">
						<div id="cajaformularios">
							<h2 class="config"><bean:message key="modificar.usuario.title" /></h2>
							
							<p><bean:message key="leyenda.campo.obligatorio" /></p>
							
							<html:form method="post" styleClass="formulario" action="/secure/ModificarUsuarioSistema.do" onsubmit="return validateModificarUsuarioSistemaForm(this)">
										...
										<div class="alinForm">
											<ul>
												<logic:iterate name="ModificarUsuarioSistemaForm" property="cartuchosList" id="cartucho" type="es.inteco.rastreador2.dao.login.CartuchoForm">
													<li><label for="<bean:write name="cartucho" property="name" />" class="noFloat"><html:multibox name="ModificarUsuarioSistemaForm" styleClass="multiboxStyle" property="selectedCartuchos" value="<%=cartucho.getId().toString() %>" styleId="<%=cartucho.getName() %>"/> <bean:write name="cartucho" property="name" /></label></li>
												</logic:iterate>
											</ul>
										</div>
									</div>
