            ...
            <div id="cajaformularios">
                ...
                <html:form styleClass="formulario" method="post" action="/secure/NuevoObservatorio.do" onsubmit="return chooseValidation(this)">
                    ...
                    <fieldset>
                        ...
                        <div class="formItem">
                            <label for="nombre" class="control-label"><strong class="labelVisu"><acronym title="<bean:message key="campo.obligatorio" />"> * </acronym><bean:message key="nuevo.observatorio.nombre" />: </strong></label>
                            <html:text styleClass="texto form-control" name="NuevoObservatorioForm" property="nombre" styleId="nombre" maxlength="100"/>
                        </div>

                        <div class="formItem">
                            <label for="type" class="control-label"><strong class="labelVisu"><acronym title="<bean:message key="campo.obligatorio" />"> * </acronym><bean:message key="nuevo.observatorio.tipo" /></strong></label>
                        ...
                        <div class="formItem">
                            <label for="cartucho" class="control-label"><strong class="labelVisu"><acronym title="<bean:message key="campo.obligatorio" />"> * </acronym><bean:message key="nuevo.observatorio.cartucho" /></strong></label>
                            <html:select name="NuevoObservatorioForm" styleClass="textoSelect form-control" styleId="cartucho" property="cartucho.id" >
                        ...
                        <div class="formItem">
                            <label for="categoria" class="control-label"><strong class="labelVisu"><bean:message key="nuevo.observatorio.categoria" />: </strong></label>
                            <html:select size="5" multiple="true" name="NuevoObservatorioForm" property="categoria" styleClass="textoSelect form-control" styleId="categoria">
                        ...
                        <div class="formItem">
                            <label for="lenguaje" class="control-label"><strong class="labelVisu"><bean:message key="nuevo.observatorio.lenguaje" /></strong></label>
                        ...
                        <div class="formItem">
                            <label for="periodicidad" class="control-label"><strong class="labelVisu"><acronym title="<bean:message key="campo.obligatorio" />"> * </acronym><bean:message key="nuevo.observatorio.periodicidad" />: </strong></label>
                        ...
                        <div class="formItem">
                            <label for="profundidad" class="control-label"><strong class="labelVisu"><acronym title="<bean:message key="campo.obligatorio" />"> * </acronym><bean:message key="nuevo.observatorio.profundidad" />: </strong></label>
                        ...
                        <div class="formItem">
                            <label for="amplitud" class="control-label"><strong class="labelVisu"><acronym title="<bean:message key="campo.obligatorio" />"> * </acronym><bean:message key="nuevo.observatorio.amplitud" />: </strong></label>
                        ...
                        <div class="formItem">
                            <label for="pseudoAleatorio" class="control-label"><strong class="labelVisu"><acronym title="<bean:message key="campo.obligatorio" />"> * </acronym><bean:message key="nuevo.observatorio.pseudoaleatorio" /></strong></label>
                        ...
                        <fieldset class="innerFieldset">
                            ...
                            <div class="formItem">
                                ...
                                <html:text styleClass="textoCorto form-control" name="NuevoObservatorioForm" property="fechaInicio" styleId="fechaInicio" onkeyup="escBarra(event, document.forms['NuevoObservatorioForm'].elements['fechaInicio'], 1)" maxlength="10"/>
                                <span id="calendar">
                            ...
                            <div class="formItem">
                                ...
                                <html:select styleClass="textoSelectCorto form-control" styleId="horaInicio" name="NuevoObservatorioForm" property="horaInicio" >
                                ...
                                <html:select styleClass="textoSelectCorto form-control" styleId="minutoInicio" name="NuevoObservatorioForm" property="minutoInicio" >
                        ...
                        <div class="formButton">
                            <html:submit property="buttonAction" styleClass="pull-left btn btn-default btn-lg"><bean:message key="boton.aceptar.anadir.semilla" /></html:submit>
