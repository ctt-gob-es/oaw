    ...
    <div id="main">
            ...
            <div id="container_der">
                ...
                <div id="cajaformularios">
                    ...
                    <h2><bean:message key="generar.informe.agregado.observatorio.title" /></h2>

                    <div class="detail">
                        <p><strong class="labelVisu"><bean:message key="generar.informes.observatorio.tiempo_espera.agregado"/></strong></p>
