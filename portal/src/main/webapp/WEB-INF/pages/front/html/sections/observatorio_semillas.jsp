	...
	<div id="migas">
		...
		<p>
			<html:link forward="indexAdmin"><bean:message key="migas.inicio" /></html:link> 
			 ...
			 / <html:link forward="newObservatory" name="paramsV"><bean:message key="migas.nuevo.observatorio" /></html:link>
			 / <bean:message key="migas.nuevo.observatorio.anadir.semillas" />
		 </p>
	</div>
	<div id="cuerpo">
		<div id="cIzq">&nbsp;</div>
				...
				<div id="cuerpoprincipal">
					...
					<div id="container_der">
						<div id="cajaformularios">
							...
							<h2 class="config"><bean:message key="semillas.observatorio.title" /></h2>
