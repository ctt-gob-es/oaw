						...
						<div id="cajaformularios">
							...
							<logic:present name="<%=Constants.CARGAR_OBSERVATORIO_FORM %>">
								...
								<logic:notEmpty name="<%=Constants.CARGAR_OBSERVATORIO_FORM %>" property="listadoObservatorio">
									<p><html:link forward="newObservatory" styleClass="boton"><span class="glyphicon glyphicon-plus" aria-hidden="true" data-toggle="tooltip" title="Crear un nuevo observatorio"></span><bean:message key="indice.observatorio.nuevo.observatorio" /></html:link>
									<div class="pag">
														...
														<ul class="lista_linea">
															<li>
																...
																<inteco:menu roles="<%=rolAdmin%>">
																	<html:link forward="editObservatory" name="params"><span class="glyphicon glyphicon-edit" aria-hidden="true" data-toggle="tooltip" title="Editar la configuración de este observatorio"/><span class="sr-only">Editar</span></html:link>
																</inteco:menu>
															...
															<li><html:link forward="resultadosPrimariosObservatorio" paramId="<%= Constants.ID_OBSERVATORIO %>" paramName="elemento" paramProperty="id_observatorio"><span class="glyphicon glyphicon-list-alt" aria-hidden="true" data-toggle="tooltip" title="Ver iteraciones de este observatorio"/><span class="sr-only">Resultados</span></html:link></li>
									...
									<p id="pCenter"><html:link forward="indexAdmin" styleClass="btn btn-default"> <bean:message key="boton.volver"/> </html:link></p>
								</logic:notEmpty>
							</logic:present>
