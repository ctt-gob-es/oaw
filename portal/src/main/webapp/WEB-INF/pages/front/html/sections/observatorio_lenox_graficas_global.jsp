					...
					<div id="container_der">
						...
						<div id="cajaformularios">
							...
							<logic:equal name="<%= Constants.OBSERVATORY_RESULTS %>" value="<%= Constants.SI %>">
								...
								<h3><bean:message key="resultados.anonimos.lenox.porcentaje.prioridad.terminos.title" /></h3>
								...
								<div class="divCenter"><img src="<%=request.getContextPath()%>/secure/GraficasObservatorio.do?<%= Constants.TYPE_OBSERVATORY %>=<%= observatoryType %>&amp;<%= Constants.ID %>=<%= id %>&amp;<%= Constants.ID_OBSERVATORIO %>=<%= id_observatorio %>&amp;<%= Constants.GRAPHIC %>=<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_PERCENTAGE_TERMS %>"></img></div>
								
								<h3><bean:message key="resultados.anonimos.lenox.porcentaje.prioridad.seg.terminos.title" /></h3>
								<div class="graphicInfo2">
									...
									<ol>
										...
										<div class="graphicInfo">
											<ol>
												<logic:iterate id="item" name="<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_PERCENTAGE_SEG_TERMS_1 %>">
													<li><bean:write name="item" property="label" /> : <bean:write name="item" property="value"/></li>
												</logic:iterate>
											</ol>
										</div></li>
										...
										<div class="graphicInfo">
											<ol>
												<logic:iterate id="item" name="<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_PERCENTAGE_SEG_TERMS_2 %>">
													<li><bean:write name="item" property="label" /> : <bean:write name="item" property="value"/></li>
												</logic:iterate>
											</ol>
										</div></li>
										...
										<div class="graphicInfo">
											<ol>
												<logic:iterate id="item" name="<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_PERCENTAGE_SEG_TERMS_3 %>">
													<li><bean:write name="item" property="label" /> : <bean:write name="item" property="value"/></li>
												</logic:iterate>
											</ol>
										</div></li>
								...
								<div class="divCenter"><img src="<%=request.getContextPath()%>/secure/GraficasObservatorio.do?<%= Constants.TYPE_OBSERVATORY %>=<%= observatoryType %>&amp;<%= Constants.ID %>=<%= id %>&amp;<%= Constants.ID_OBSERVATORIO %>=<%= id_observatorio %>&amp;<%= Constants.GRAPHIC %>=<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_PERCENTAGE_SEG_TERMS %>"></img></div>
								
								<h3><bean:message key="resultados.anonimos.lenox.numero.prioridad.seg.terminos.title" /></h3>
								<div class="graphicInfo2">
									<strong><bean:message key="resultados.anonimos.numero.terminos" /></strong>
									<ol>
										<li><strong><bean:message key="resultados.anonimos.segmentoI"/></strong>
										<div class="graphicInfo">
											<ol>
												<logic:iterate id="item" name="<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_NUMBER_SEG_TERMS_1 %>">
													<li><bean:write name="item" property="label" /> : <bean:write name="item" property="value"/></li>
												</logic:iterate>
											</ol>
										</div></li>
										...
										<div class="graphicInfo">
											<ol>
												<logic:iterate id="item" name="<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_NUMBER_SEG_TERMS_2 %>">
													<li><bean:write name="item" property="label" /> : <bean:write name="item" property="value"/></li>
												</logic:iterate>
											</ol>
										</div></li>
										...
										<div class="graphicInfo">
											<ol>
												<logic:iterate id="item" name="<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_NUMBER_SEG_TERMS_3 %>">
													<li><bean:write name="item" property="label" /> : <bean:write name="item" property="value"/></li>
												</logic:iterate>
											</ol>
										</div></li>
								...
								<div class="divCenter"><img src="<%=request.getContextPath()%>/secure/GraficasObservatorio.do?<%= Constants.TYPE_OBSERVATORY %>=<%= observatoryType %>&amp;<%= Constants.ID %>=<%= id %>&amp;<%= Constants.ID_OBSERVATORIO %>=<%= id_observatorio %>&amp;<%= Constants.GRAPHIC %>=<%= Constants.OBSERVATORY_LENOX_GRAPHIC_GLOBAL_NUMBER_SEG_TERMS %>"></img></div>
