...
<script>
	...
	var colNameDepthReport = '<bean:message key="colname.depthReport"/>';
	...
	var translatedColNames = [ "URL", colNameWebsiteType, colNameUser,
			...
			colNameHistoric, colNameStatus, colNameRequestDate,
			colNameSendDate, colNameDepthReport
...
<div id="main">
		...
		<div id="migas">
			...
			<ol class="breadcrumb">
				<li class="active">
					...
					<bean:message key="migas.diagnostico" />
				</li>
			</ol>
		</div>
				...
				<fieldset>
					...
					<div class="formItem">
						<label for="usuario" class="control-label">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.estadisticas.usuario" />
							</strong>
						</label>
						<input type="text" class="texto form-control" id="usuario" name="usuario" />
					</div>
					<div class="formItem">
						<label for="url" class="control-label">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.estadisticas.url" />
							</strong>
						</label>
						<input type="text" class="texto form-control" id="url" name="url" />
					</div>
					<div class="formItem">
					...
					<div class="formItem">
						<label for="profundidad">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.estadisticas.profundidad" />
							</strong>
						</label>
						<select id="profundidad" name="profundidad" class="texto form-control">
					...
					<div class="formItem">
						<label for="amplitud">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.estadisticas.amplitud" />
							</strong>
						</label>
						<select id="amplitud" name="amplitud" class="texto form-control">
							<option selected="selected" value=""></option>
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
					...
					<div class="formItem">
						<label for="informe">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.estadisticas.informe" />
							</strong>
						</label>
						<select id="informe" name="informe" class="texto form-control">
							<option selected="selected" value=""></option>
					...
					<div class="formItem">
						<label for="amplitud">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.estadisticas.tipo" />
							</strong>
						</label>
						<select id="tipo" name="tipo" class="texto form-control">
							<option selected="selected" value=""></option>
					...
					<div class="formItem">
						<label for="amplitud">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.estadisticas.estado" />
							</strong>
						</label>
						<select id="estado" name="estado" class="texto form-control">
							<option selected="selected" value=""></option>
							<option value="launched"><bean:message key="status.launched" /></option>
							<option value="finished"><bean:message key="status.finished" /></option>
							<option value="not_crawled"><bean:message key="status.not.crawled" /></option>
							<option value="error">Error</option>
							<option value="missing_params"><bean:message key="status.wrong.params" /></option>
						</select>
					</div>
					<div class="formItem">
						<label for="amplitud">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.estadisticas.directorio" />
							</strong>
						</label>
						<select id="informe" name="informe" class="texto form-control">
							<option selected="selected" value=""></option>
					...
					<div class="formItem">
						<label for="depthReport">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.estadisticas.informe.profundidad" />
							</strong>
						</label>
						<select id="depthReport" name="depthReport" class="texto form-control">
							<option selected="selected" value=""></option>
					...
					<div class="formItem">
						<label for="startDate">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.fecha.inicio" />
							</strong>
						</label>
						<html:text styleClass="textoCorto form-control" name="ServicioDiagnosticoForm" property="startDate"
							...
							maxlength="10" />
						<span>
							<img src="../images/boton-calendario.gif"
					...
					<div class="formItem">
						<label for="endDate">
							<strong class="labelVisu">
								<bean:message key="servicio.diagnostico.fecha.fin" />
							</strong>
						</label>
					...
					<div class="formButton">
						...
						<span onclick="exportar()" class="btn btn-primary btn-lg">
							<span aria-hidden="true"></span>
	...
	<div id="fullwidthgrid">
		...
		<div class="col-md-12">
			<p class="pull-left">
				<strong>
					<bean:message key="servicio.diagnostico.estadisticas.avg" />
				</strong>
				<span id="avg">0</span>
			</p>
		</div>
