        ...
        <div id="container_der">
            ...
            <div id="migas">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><html:link forward="resultadosObservatorioSemillas" paramId="<%= Constants.OBSERVATORY_ID %>" paramName="<%= Constants.OBSERVATORY_ID %>"><bean:message key="migas.resultado.observatorio" /></html:link></li>
                    <li><html:link forward="resultadosObservatorioSemillasLista" name="paramsVolver"><bean:message key="migas.resultado.rastreos.realizados.observatorio" /></html:link></li>
                    <li><html:link forward="showTracking" name="paramsVolverAFC"><bean:message key="migas.rastreos.realizados.url.analizadas" /></html:link></li>
            ...
            <div id="cajaformularios">
                ...
                <p id="pCenter">
                    <html:link styleClass="btn btn-default btn-lg" forward="showTracking" name="paramsVolverAFC"><bean:message key="boton.volver"/> </html:link>
                </p>
