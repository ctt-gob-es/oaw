    ...
    <div id="main">
        ...
        <div id="container_der">
            ...
            <div id="cajaformularios">
                ...
                <h2><bean:message key="importar.semillas.title" /></h2>

                <div class="detail">
                    <p><strong class="labelVisu"><bean:message key=importar.semillas.info" /></strong></p>
                    ...
                    <p><strong class="labelVisu"><bean:message key="importar.semillas.info2" /></strong></p>
